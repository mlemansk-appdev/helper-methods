class DirectorsController < ApplicationController
  ...
  def create
    ...
    directors_attributes = params.require(:director).permit(:name, :dob)
    @director = Director.new(directors_attributes)
  ...
  def update
    @director = Director.find(params.fetch(:id))
    updated_attributes = params.require(:director).permit(:name, :dob)
    @director.update(updated_attributes)
